...
and p-values, the `mice` package provides
[`pool()`](https://amices.org/mice/reference/pool.html) and can be used
...
#>  [4] ranger_0.18.0       plotrix_3.8-14      Rcpp_1.1.1         
#>  [7] jquerylib_0.1.4     systemfonts_1.3.1   textshaping_1.0.4  
#> [10] yaml_2.3.10         fastmap_1.2.0       lattice_0.22-7     
#> [13] R6_2.6.1            Formula_1.2-5       knitr_1.50         
#> [16] htmlwidgets_1.6.4   MASS_7.3-65         tibble_3.3.1       
#> [19] desc_1.4.3          nnet_7.3-20         bslib_0.9.0        
#> [22] pillar_1.11.1       rlang_1.1.7         cachem_1.1.0       
#> [25] xfun_0.54           fs_2.0.1            sass_0.4.10        
#> [28] earth_5.3.5         cli_3.6.5           pkgdown_2.2.0      
#> [31] magrittr_2.0.4      digest_0.6.39       grid_4.5.2         
#> [34] rstudioapi_0.17.1   plotmo_3.7.0        xgboost_3.2.1.1    
#> [37] lifecycle_1.0.5     vctrs_0.7.2         data.table_1.18.2.1
#> [40] evaluate_1.0.5      glue_1.8.0          ragg_1.5.0         
